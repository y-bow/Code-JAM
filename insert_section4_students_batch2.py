...
def insert_section4_batch2():
    ...
    with app.app_context():
        ...
        print(f"Adding Batch 2 students to {scds_school.name}, {section4.name} (ID: {section4.id})")

        # Load students from JSON
        with open('section4_students_batch2.json', 'r') as f:
        ...
        db.session.commit()
        print(f"\nFinished! Added {added_count} batch 2 students to Section 4, skipped {skipped_count}.")

if __name__ == "__main__":
    insert_section4_batch2()
